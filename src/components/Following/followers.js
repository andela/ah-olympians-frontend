...
class Follow extends Component {
  ...
  render() {
    ...
    const {
      userProfiles, followersList, following, followers,
    } = this.props;
        ...
        <Container>
          <div className="row page-top">
            ...
            <div className="col-sm-8">
              <h2 className="text-center page-header">Followers</h2>
              {Object.keys(followersList).map(key => (
...
const mapStateToProp = state => ({
  ...
  followersList: state.following.followers.followers,
  following: state.following.following,
  followers: state.following.followers.followers_count,
});

const Followers = connect(mapStateToProp, mapDispatchToProps)(Follow);
